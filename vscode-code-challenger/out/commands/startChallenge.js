...
const challengeProvider_1 = require("../services/challengeProvider");
function startChallenge() {
    const challengeProvider = new challengeProvider_1.ChallengeProvider();
    const challenges = challengeProvider.getChallenges();
    vscode.window.showQuickPick(challenges.map(c => ({
        label: c.title,
        description: c.id,
